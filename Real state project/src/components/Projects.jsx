...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="container mx-auto py-4 pt-20 px-6 md:px-20 w-full overflow-hidden"
      id="Projects"
    >
      ...
      <div className="overflow-hidden">
        ...
        >
          {projectsData.map((project, index) => (
            <div 
              key={index} 
              className="relative flexshrink-0 w-full sm:w-1/4"
              style={{ minWidth: `${100 / cardsToShow}%` }} // Dynamic width allocation
            >
              ...
              <div className="absolute left-0 right-0 bottom-5 flex justify-center">
                <div className="inline-block bg-white w-3/4 px-4 py-2 shadow-md">
                  ...
                  <p className="text-gray-500 text-sm">
                    {project.title}<span className="p-1"></span>{project.location}
                  </p>
                </div>
              </div>
            </div>
