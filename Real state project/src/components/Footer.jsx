    ...
    return(
      ...
      " id="Footer">
       ...
       <p className="text-gray-400 mt-4">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia rem architecto quasi facere! Nam debitis adipisci labore quo vel aut odio veniam quod perferendis maxime!
       </p>
       </div>
